...
class TestRouterCore:
    ...
    def _rows(self):
        return [
            ...
            accounts_row("acme-max", 88.0, expired=False, active=True),
        ]
...
class TestRoutePickFable:
    ...
    def test_seven_day_floor_excludes_the_weekly_trap(self):
        # gmail-shaped: freshest fable but weekly (7d) maxed → skip; alumni wins.
        ...
        assert accounts.route_pick_fable(rows, set()) == "alumni"
...
class TestPickEnvFable:
    ...
    def test_fable_first_orders_eligible_by_fable(self):
        rows = [_route_row("gmail", 10.0, fable=80.0),
                _route_row("alumni", 50.0, fable=10.0),
    ...
    def test_prefers_fable_over_headroom(self):
        ...
        rows = [_route_row("gmail", 5.0, fable=100.0), _route_row("alumni", 50.0, fable=10.0)]
    ...
    def test_falls_back_to_headroom_when_none_eligible(self):
        ...
        rows = [_route_row("gmail", 5.0, fable=100.0), _route_row("alumni", 50.0, fable=100.0)]
        picked = accounts.pick_route(accounts._fable_first(rows), self.VAULT, set(), self.NOW, None)
    ...
    def test_skips_eligible_without_token(self):
        ...
        rows = [_route_row("alumni", 20.0, fable=10.0), _route_row("ymail", 30.0, fable=40.0)]
    ...
    def test_skips_weekly_maxed_fable_account(self):
        ...
        rows = [_route_row("gmail", 0.0, fable=8.0, seven_day=100.0),
                _route_row("alumni", 34.0, fable=41.0, seven_day=52.0)]
        picked = accounts.pick_route(accounts._fable_first(rows), self.VAULT, set(), self.NOW, None)
        assert picked == ("alumni", "sk-alumni")
